...
/**
 * GET /users/store/products/search
 * View own products
 */
routes.get('/users/store/products/search',
  auth(),
  validateParam(constraints.listStoreProduct),
  wrap(ProductController.storeProductsSearch),
  apiResponse());
...
routes.post('/products',
  ...
  validateParam(constraints.createWholesale, true, 'wholesales', false),
  validateParam(constraints.createExpeditions, true, 'expeditions', true),
  validateParam(constraints.createImages, true, 'images', true),
...
routes.put('/users/store/products/:id([0-9]{1,10})',
  ...
  validateParam(constraints.updateWholesale, true, 'wholesales'),
  validateParam(constraints.updateExpeditions, true, 'expeditions'),
  validateParam(constraints.createImages, true, 'images'),
